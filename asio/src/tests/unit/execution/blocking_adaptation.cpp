...
void test_can_query()
{
  ASIO_CONSTEXPR bool b = asio::can_query<Executor, Param>::value;
  ASIO_CHECK(b == ExpectedResult);
}
...
{
  ASIO_CONSTEXPR bool b = asio::can_prefer<Executor, Param>::value;
  ASIO_CHECK(b == ExpectedResult);
}
