...
struct bulk_guarantee_t
{
  ...
  friend ASIO_CONSTEXPR bulk_guarantee_t query(
    ...
    ASIO_NOEXCEPT_IF((is_nothrow_query<Executor, unsequenced_t>::value))
  ...
  friend ASIO_CONSTEXPR bulk_guarantee_t query(
      const Executor& ex, convertible_from_bulk_guarantee_t,
      typename enable_if<
        !can_query<Executor, unsequenced_t>::value
          && can_query<Executor, sequenced_t>::value
      >::type* = 0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
    ASIO_NOEXCEPT_IF((is_nothrow_query<Executor, sequenced_t>::value))
#endif // !defined(__clang__)
  {
  ...
  friend ASIO_CONSTEXPR bulk_guarantee_t query(
      ...
      typename enable_if<
        !can_query<Executor, unsequenced_t>::value
          && !can_query<Executor, sequenced_t>::value
          && can_query<Executor, parallel_t>::value
      >::type* = 0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
    ASIO_NOEXCEPT_IF((is_nothrow_query<Executor, parallel_t>::value))
#endif // !defined(__clang__)
  {
...
namespace { static const bulk_guarantee_t& bulk_guarantee = bulk_guarantee_t::instance; }
#endif
