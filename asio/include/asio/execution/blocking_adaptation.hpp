...
#ifndef ASIO_EXECUTION_BLOCKING_RELATIONSHIP_HPP
#define ASIO_EXECUTION_BLOCKING_RELATIONSHIP_HPP
...
struct blocking_adaptation_t
{
  ...
  friend ASIO_CONSTEXPR blocking_adaptation_t query(
      ...
      typename enable_if<
        can_query<Executor, disallowed_t>::value
      >::type* = 0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
    ASIO_NOEXCEPT_IF((is_nothrow_query<Executor, disallowed_t>::value))
  ...
  friend ASIO_CONSTEXPR blocking_adaptation_t query(
      ...
      typename enable_if<
        !can_query<Executor, disallowed_t>::value
          && can_query<Executor, allowed_t>::value
      >::type* = 0)
#if !defined(__clang__) // Clang crashes if noexcept is used here.
    ASIO_NOEXCEPT_IF((is_nothrow_query<Executor, allowed_t>::value))
#endif // !defined(__clang__)
  {
...
#endif // ASIO_EXECUTION_BLOCKING_RELATIONSHIP_HPP
